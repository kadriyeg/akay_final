...
class _AlgoritmaQuestionsScreenState extends State<AlgoritmaQuestionsScreen> {
  List<Question> _questions = [
    Question(
      id: '10',
      title: '“Bir sorunu çözmek veya belirlenmiş bir amaca ulaşmak için tasarlanan yola, takip edilen işlem basamaklarına ……………….. denir.”\nYukarıdaki tanımda boş bırakılan yere aşağıdaki kavramlardan hangisi gelmelidir?',
      options: {' Programlama Dili': false,'Algoritma': true, 'Yazılım': false, 'Problem': false},
    ),
    Question(
      id: '10',
    ...
    Question(
      ...
      options: {'  2 ve 4': false, '2 ve 3': false, '4 ve 5': false, '6 ve 7': true},
    ),
    Question(
      id: '10',
      ...
      options: {'İki sayının hangisinin büyük olduğunu bulur ': true, 'İki sayıyı toplar': false, 'Birbirine eşit iki sayıyı bulur': false, 'Sayıların toplamını çıktı olarak verir': false},
    ),
    Question(
      id: '10',
      ...
      options: {'İ =1, n=1': false, 'Yaş bilgisi alınır': false, 'Yaş 25’Ten büyükse maaş 5000’e eşit mi kontrol edilir':false, '25 yaşından küçüklerin 5000 tl maaş alıp almadığı kontrol edilir.':  true},
    ),
    Question(
      id: '10',
      title: 'a.Ekmeği al\nb.Bitir\nc.Sokağa çık\nd.Markete git\ne.Eve dön\nf.Kasaya götür\ng.Başla\nh.Parayı öde\nYukarıda ekmek alma algoritmasının adımları karışık olarak verilmiştir. Aşağıdaki seçeneklerden hangisinde bu adımlar doğru olarak sıralanmıştır?',
      options: {'g,c,d,a,f,h,e,b': true, 'c,d,h,a,b,e,f,g': false, 'a,h,c,d,e,f,g,b': false, 'g,d,e,a,h,f,c,b': false},
    ),
  ];
